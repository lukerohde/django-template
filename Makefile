...
help:
	...
	@echo "  test-headed - Run playwright tests in headed mode (needs xquartz setup)"
	@echo "  test-debug  - Run playwright tests in interactive debug mode (needs xquartz setup)"
